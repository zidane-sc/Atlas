  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {/* Skill grid */}
        <div className="p-6">
          <div className="mb-4 font-display text-[9px] tracking-widest" style={{ color: "var(--color-status-ready)" }}>
            ▸ SKILL PROFICIENCIES
          </div>
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-3">
            {sheet.skills.map((skill) => {
              ...
              return (
                <div
                  key={skill.type}
                  className="relative bg-card p-3.5"
                  style={{
                    border: `2px solid ${isEmpty ? "var(--color-border)" : `var(${meta.colorVar})`}`,
                    borderLeftWidth: "4px",
                ...
                >
                  ...
                  <div className="mb-2 flex items-center gap-2" style={{ marginRight: 52 }}>
                  ...
                  <div className="mb-3 text-sm" style={{ color: "var(--color-dim)", lineHeight: 1.4 }}>{meta.desc}</div>
